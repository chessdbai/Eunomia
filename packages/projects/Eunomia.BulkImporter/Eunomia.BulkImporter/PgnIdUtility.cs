...
namespace Eunomia.BulkImporter
{
    ...
    public static class PgnIdUtility
    {
        ...
        /// <param name="originalText">The original PGN text.</param>
        /// <returns>The unique id.</returns>
        public static GameId GenerateGameId(PgnGame pgnGame, string originalText)
        {
            ...
            var uniqueId = Sha256AsHex(originalText);
